...
//
// modified for stand-alone (2011/01/06)
// Real -> double (2011/01/17)

#ifndef __MassActionProcess_hpp
#define __MassActionProcess_hpp

#include "libecs/ContinuousProcess.hpp" // change code (2010/12/28)
// #include <ContinuousProcess.hpp>
#include "SpatiocyteStepper.hpp"
#include "SpatiocyteCommon.hpp"

class MassActionProcess : public ContinuousProcess // change code (2010/12/28)
{ 
