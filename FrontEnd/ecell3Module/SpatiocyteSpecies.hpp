...
#include "libecs/Variable.hpp" // add (2010/12/24)
// #include <Variable.hpp> comment out (2010/12/20)
...
public:
  Species(SpatiocyteStepper* aStepper, Variable* aVariable, int anID, 
    ...
    theMoleculeSize(0),
    D(0),
    theDiffusionInterval(std::numeric_limits<double>::infinity()),// change code (2010/12/22)
