  ...
  if(A->getIsVolume() && B->getIsVolume())
      ...
      if(A != B)
          ...
          if(p == -1)
            {
              ...
              p = k/(6.0*sqrt(2.0)*(D_A+D_B)*r_v);
              //p = k/(6*sqrt(2)*(D_A+D_B)*r_v);
            }
          else
            {
              // change integer argument to double in sqrt (2011/01/31)
              k = p*(6.0*sqrt(2.0)*(D_A+D_B)*r_v);
      ...
      else
        {
          if(p == -1)
            {
              // change integer argument to double in sqrt (2011/01/31)
              p = k/(6.0*sqrt(2.0)*D_A*r_v);
              //p = k/(6*sqrt(2)*D_A*r_v);
            }
          else
            {
              // change integer argument to double in sqrt (2011/01/31)
              k = p*(6.0*sqrt(2.0)*D_A*r_v);
      ...
      if(A->getCompartment() != B->getCompartment())
      ...
      else if(A != B)
        {
          if(p == -1)
            {
              // change integer argument to double in sqrt (2011/01/31)
              p = pow(2.0*sqrt(2.0)+4.0*sqrt(3.0)+3.0*sqrt(6.0)+sqrt(22.0), 2)*k/
                (72.0*(6.0*sqrt(2.0)+4.0*sqrt(3.0)+3.0*sqrt(6.0))*(D_A+D_B));
            ...
            {
              // change integer argument to double in sqrt (2011/01/31)
              k = p*(72.0*(6.0*sqrt(2.0)+4.0*sqrt(3.0)+3.0*sqrt(6.0))*(D_A+D_B))/
                pow(2.0*sqrt(2.0)+4.0*sqrt(3.0)+3.0*sqrt(6.0)+sqrt(22.0), 2);
          ...
          if(p == -1)
            {
              // change integer argument to double in sqrt (2011/01/31)
              p = pow(2.0*sqrt(2.0)+4.0*sqrt(3.0)+3.0*sqrt(6.0)+sqrt(22.0), 2)*k/
                (72.0*(6.0*sqrt(2.0)+4.0*sqrt(3.0)+3.0*sqrt(6.0))*(D_A));
              //p = pow(2*sqrt(2)+4*sqrt(3)+3*sqrt(6)+sqrt(22), 2)*k/
            ...
            {
              // change integer argument to double in sqrt (2011/01/31)
              k = p*(72.0*(6.0*sqrt(2.0)+4.0*sqrt(3.0)+3.0*sqrt(6.0))*(D_A))/
                pow(2.0*sqrt(2.0)+4.0*sqrt(3.0)+3.0*sqrt(6.0)+sqrt(22.0), 2);
  ...
  else if(A->getIsVolume() && B->getIsLipid())
    {
      if(p == -1)
        {
          // change integer argument to double in sqrt (2011/01/31)
          p = 24.0*k*r_v/((6.0+3.0*sqrt(3.0)+2.0*sqrt(6.0))*D_A);
          //p = 24*k*r_v/((6+3*sqrt(3)+2*sqrt(6))*D_A);
        }
      else
        {
          // change integer argument to double in sqrt (2011/01/31)
          k = p*((6.0+3.0*sqrt(3.0)+2.0*sqrt(6.0))*D_A)/(24.0*r_v);
  ...
  else if(A->getIsLipid() && B->getIsVolume())
    {
      if(p == -1)
        {
          // change integer argument to double in sqrt (2011/01/31)
          p = 24.0*k*r_v/((6.0+3.0*sqrt(3.0)+2.0*sqrt(6.0))*D_B);
          //p = 24*k*r_v/((6+3*sqrt(3)+2*sqrt(6))*D_B);
        }
      else
        {
          // change integer argument to double in sqrt (2011/01/31)
          k = p*((6.0+3.0*sqrt(3.0)+2.0*sqrt(6.0))*D_B)/(24.0*r_v);
  ...
  else if(A->getIsVolume() && !B->getIsVolume())
    {
      if(p == -1)
        {
          // change integer argument to double in sqrt (2011/01/31)
          p = sqrt(2.0)*k/(3.0*D_A*r_v);
          //p = sqrt(2)*k/(3*D_A*r_v);
        }
      else
        {
          // change integer argument to double in sqrt (2011/01/31)
          k = p*(3.0*D_A*r_v)/sqrt(2.0);
  ...
  else if(!A->getIsVolume() && B->getIsVolume())
    {
      if(p == -1)
        {
          // change integer argument to double in sqrt (2011/01/31)
          p = sqrt(2.0)*k/(3.0*D_B*r_v);
          //p = sqrt(2)*k/(3*D_B*r_v);
        }
      else
        {
          // change integer argument to double in sqrt (2011/01/31)
          k = p*(3.0*D_B*r_v)/sqrt(2.0);
